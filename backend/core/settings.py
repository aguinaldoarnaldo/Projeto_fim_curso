...
MIDDLEWARE = [
    ...
    'apis.middleware.SessionActivityMiddleware',
]
...
# Cache Configuration
# Usando LocMemCache para desenvolvimento/homologação. 
# Para produção com 10k+ usuários, RECOMENDA-SE substituir por Redis.
CACHES = {
    'default': {
...
# JWT Configuration
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=4),  # Token expira em 4h (inatividade de frontend é 3h)
